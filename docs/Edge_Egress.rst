...
To use the client libraries, you must first create an SdsEdgeService instance, as shown here:

``var edgeServer = new SdsEdgeService(new Uri(“https://your_eds_server:5000”));``

You use the ``SdsEdgeService`` instance to  access much of the functionality of Edge Data Store. To configure the 
Egress feature of Edge Data Store, create an instance of ``ISdsEdgeEgressService`` as shown here:
